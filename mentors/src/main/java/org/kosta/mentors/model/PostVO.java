...
public class PostVO {
	...
	//자유게시판 조회시 사용할 생성자 
	public PostVO(long postNo, String title, long hits, String timePosted, MemberVO memberVO) {
		super();
		this.postNo = postNo;
		this.title = title;
		this.hits = hits;
	...
	//자유게시판 상세글보기
	public PostVO(long postNo, String title, String content, long hits, String timePosted, MemberVO memberVO) {
		super();
		this.postNo = postNo;
		this.title = title;
		this.content = content;
