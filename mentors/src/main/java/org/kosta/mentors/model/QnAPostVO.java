...
public class QnAPostVO extends PostVO {
	...
	public QnAPostVO(long no, String title, long hits, String timePosted,String category, MemberVO memberVO) {
		super(no, title, hits, timePosted, memberVO);
		this.category=category;
	}
	public QnAPostVO(long no, String title, String content, long hits, String timePosted,String category, MemberVO memberVO) {
